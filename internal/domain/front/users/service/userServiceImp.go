...
import (
	"errors"
	"github.com/hudayberdipolat/go-newsApp-backend/internal/domain/front/users/dto"
...
func (u userServiceImp) RegisterUser(request dto.RegisterUserRequest) (*dto.UserResponse, error) {
	...
	userResponse := dto.NewUserResponse(*getUser, accessToken)
	return &userResponse, nil
}

func (u userServiceImp) LoginUser(request dto.LoginUserRequest) (*dto.UserResponse, error) {
